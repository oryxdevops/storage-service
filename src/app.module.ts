...
@Module({
  ...
  controllers: [AppController, FileUploadsController, FileController, QidController, PassportController, PhotoController, AcademicQualificationController, EnglishSkillController],
